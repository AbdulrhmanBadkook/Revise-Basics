...
private:
    ...
    static stLoginRegisterRecord _ConvertLoginRegisterLineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        LoginRegisterRecord.Password = clsutil::Decrypt_text(LoginRegisterDataLine[2]);
    ...
    string _prepareLogin(string Seperator = "#//#") {
        ...
        data += clsutil::Encrypt_text(Password )+ Seperator;
...
public:
    ...
    enum enPermissions {
        ...
        pUpdateClients = 8, pFindClient = 16, pTranactions = 32, pManageUsers = 64,pHistory=128
    };
    struct stLoginRegisterRecord
    {
        string DateTime;
  ...
  bool Check_permission(enPermissions permission){
