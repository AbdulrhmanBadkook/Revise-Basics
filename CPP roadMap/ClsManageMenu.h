...
#include <iomanip>
#include"clsGetUserList.h"
#include "clsDeleteusr.h"
#include "clsAddUser.h"
#include"clsUpdateUsr.h"
#include"ClsFindUsr.h"

using namespace std;

class ClsManageMenu :protected clsScreen
{
...
private:
    ...
    static void _ShowDeleteUserScreen()
    {
        ...
        clsDeleteusr::ShowDeleteUserScreen();
    }

    static void _ShowUpdateUserScreen()
    {
        clsUpdateUsr::ShowUpdateUserScreen();

    }

    static void _ShowFindUserScreen()
    {
        ClsFindUsr::ShowFindUserScreen();
